...
public class OrderRepository {
    ...
    public List<Order> finaAll(OrderSearch orderSearch){
        ...
        return query
                ...
                .where(sattusEq(orderSearch.getOrderStatus()), nameLike(orderSearch.getMemberName()))
                .limit(1000)
                .fetch();
    }
    ...
    private BooleanExpression sattusEq(OrderStatus statusCond){
        if(statusCond == null){
            return null;
        }
    ...
    // Fetch Join으로 LAZY 무시하고 진짜 객체를 가져온다.
    // ToOne 관계라 한방 쿼리
