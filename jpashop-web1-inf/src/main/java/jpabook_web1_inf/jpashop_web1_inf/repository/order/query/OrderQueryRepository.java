package jpabook_web1_inf.jpashop_web1_inf.repository.order.query;
...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrders() {
        return em.createQuery(
                        "select new jpabook_web1_inf.jpashop_web1_inf.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                                " from Order o" +
                                " join o.member m" +
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                "select new jpabook_web1_inf.jpashop_web1_inf.repository.order.query.OrderFlatDto(o.id, m.name, o.orderDate, o.status, d.address, i.name, oi.orderPrice, oi.count)" +
                        " from Order o" +
                        " join o.member m" +
                        " join o.delivery d" +
